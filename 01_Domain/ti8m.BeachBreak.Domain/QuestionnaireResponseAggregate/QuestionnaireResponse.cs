...
/// <summary>
/// Aggregate root representing an employee's response to a questionnaire assignment.
...
public class QuestionnaireResponse : AggregateRoot
{
    ...
    public Dictionary<Guid, Dictionary<Guid, object>> SectionResponses { get; private set; } = new();
    ...
    /// </summary>
    public void RecordSectionResponse(Guid sectionId, Dictionary<Guid, object> questionResponses)
    {
    ...
    {
        SectionResponses[@event.SectionId] = @event.QuestionResponses;
