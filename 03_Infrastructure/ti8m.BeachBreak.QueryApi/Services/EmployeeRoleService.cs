...
namespace ti8m.BeachBreak.QueryApi.Services;

/// <summary>
/// Service for retrieving employee roles with cache-through pattern for Query side.
/// Implements reliable access to employee roles while abstracting caching details from controllers.
/// </summary>
public class EmployeeRoleService : IEmployeeRoleService
{
    ...
    public async Task<EmployeeRoleResult?> GetEmployeeRoleAsync(Guid userId, CancellationToken cancellationToken = default)
    {
        try
        {
