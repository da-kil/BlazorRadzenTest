...
/// Returns finalized questionnaires for the same employee, same category, that have ANY goals.
...
public class GetAvailablePredecessorsQuery : IQuery<Result<IEnumerable<AvailablePredecessorDto>>>
{
    ...
    public GetAvailablePredecessorsQuery(Guid assignmentId, Guid requestingUserId)
    {
